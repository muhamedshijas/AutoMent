...
function UserProfile() {
  ...
  return (
    <div>{
      isLoading ? <div className="admin-loading"> <ReactLoading type="spinningBubbles" color="#2C457E" height={80} width={80} /></div> : <div className="userProfile">
        ...
        {currentBookings[0] ? <div className="serviceHistory">
          ...
          <div className="pagination">
            ...
            <button
              ...
              disabled={indexOfLastBooking >= bookingList.length}
            >
              Next
            </button>
          </div>
